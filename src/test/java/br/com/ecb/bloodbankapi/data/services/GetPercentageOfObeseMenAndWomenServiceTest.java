...
@SpringBootTest
public class GetPercentageOfObeseMenAndWomenServiceTest {
    private SavePerson savePersonService;
    private ListPersonsService listPersonsService;
    private GetBMI getBMIService;
    private GetPercentageOfObeseMenAndWomenService getPercentageOfObeseMenAndWomenService;
    ...
    public void init() {
        ...
        getPercentageOfObeseMenAndWomenService = new GetPercentageOfObeseMenAndWomenService(getBMIService);
    }

    @Test
    public void testGetPercentageOfObeseMenAndWomenSuccessfully() {
