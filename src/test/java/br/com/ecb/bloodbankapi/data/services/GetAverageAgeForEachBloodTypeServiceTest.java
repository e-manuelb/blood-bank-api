...
@SpringBootTest
public class GetAverageAgeForEachBloodTypeServiceTest {
    private SavePerson savePersonService;
    private ListPersonsService listPersonsService;
    private GetAverageAgeForEachBloodTypeService getAverageAgeForEachBloodTypeService;
    ...
    public void init() {
        ...
        getAverageAgeForEachBloodTypeService = new GetAverageAgeForEachBloodTypeService();
    }

    @Test
    public void testGetAverageAgeForEachBloodTypeSuccessfully() {
        ...
        List<Object> averageAgeForEachBloodType = getAverageAgeForEachBloodTypeService.handle(listedPeople);

        Assertions.assertNotNull(averageAgeForEachBloodType);
    }
}
