...
@SpringBootTest
public class GetAvailableDonorsForEachBloodTypeServiceTest {
    private SavePerson savePersonService;
    private ListPersonsService listPersonsService;
    private GetAvailableDonorsForEachBloodTypeService getAvailableDonorsForEachBloodTypeService;
    ...
    public void init() {
        ...
        getAvailableDonorsForEachBloodTypeService = new GetAvailableDonorsForEachBloodTypeService();
    }

    @Test
    public void testGetAvailableDonorsForEachBloodTypeSuccessfully() {
        ...
        List<Object> availableDonorsForEachBloodType = getAvailableDonorsForEachBloodTypeService.handle(listedPeople);

        Assertions.assertNotNull(availableDonorsForEachBloodType);
    }
}
